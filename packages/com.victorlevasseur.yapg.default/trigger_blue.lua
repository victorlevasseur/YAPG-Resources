entity_template = {
    name = "yapg_trigger_blue",
    friendlyname = "[YAPG] Blue trigger",
                ...
                ["trigger"] = {
                    ...
                    on_collision_begin = function(entity, other)
                        if(player(other) ~= nil) then
                            ...
                            local red_blocks = current_level:get_entities("com.victorlevasseur.yapg.default.yapg_block_blue_activable")
        ...
        ["render"] = {
            ...
            animations = {
                ["deactivated"] = {
                    ...
                    frames = {
                        {
                            rect = { left = 96, top = 64, width = 32, height = 32},
                            relative_duration = 1,
                        },
                    },
                },
                ["activated"] = {
                    ...
                    frames = {
                        {
                            rect = { left = 96, top = 96, width = 32, height = 32},
                            relative_duration = 1,
                        },
                    },
                },
